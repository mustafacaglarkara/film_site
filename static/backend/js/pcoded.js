...
// Main layout change function - moved to the top
function main_layout_change(value) {
  if (value == 'horizontal') {
    ...
    return document.querySelector('body').getAttribute('data-pc-layout') == 'horizontal';
  }
  return false;
}
...
function setLayout() {
  ...
  if (layout !== null && layout !== '') {
    ...
    if (layout === 'horizontal') {
      ...
      script.src = '/static/backend/js/layout-horizontal.js'; // Load script for horizontal layout
      document.body.appendChild(script);
    } else if (layout === 'color-header') {
      // Change logo color for color-header layout
      if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
        document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '/static/backend/images/logo-white.svg');
      }
    } else if (layout === 'compact') {
      script.src = '/static/backend/js/layout-compact.js'; // Load script for compact layout
      document.body.appendChild(script);
    } else if (layout === 'tab') {
      script.src = '/static/backend/js/layout-tab.js'; // Load script for tab layout
      document.body.appendChild(script);
    }
  }
...
for (var t = 0; t < tc.length; t++) {
  tc[t].setAttribute('src', 'static/backend/images/logo-white.svg');
}
...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', '/static/backend/images/logo-white.svg');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', '/static/backend/images/logo-white.svg');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', '/static/backend/images/logo-white.svg');
    }
    ...
    dark_flag = false;
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '/static/backend/images/logo-dark.svg');
    }
    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', '/static/backend/images/logo-dark.svg');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', '/static/backend/images/logo-dark.svg');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', '/static/backend/images/logo-dark.svg');
    }
    var control = document.querySelector('.theme-layout .btn.active');
    if (control) {
      document.querySelector('.theme-layout .btn.active').classList.remove('active');
